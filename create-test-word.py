...
# יצירת קובץ Word לבדיקה עם האלגוריתם החדש
import sys
import os
import json
...
print("Creating Word document with new algorithm...")

# יצירת הקובץ
output_path = "TEST-WITHOUT-HEBREW-PROCESSING.docx"

try:
    # יצירת מסמך Word עם האלגוריתם החדש
    success = create_hebrew_word_document(
        transcription=text,
        title="בדיקת אלגוריתם פסקאות חדש",
    ...
    if success:
        ...
        print("You can now open this file to see the paragraph splitting!")
    else:
        print("FAILED: Could not create Word document")

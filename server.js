  ...
  try {
    ...
    sections.forEach(section => {
      ...
      combinedSection = combinedSection
        // קודם תקן אכרונים עבריים - רק במקרים שמתחילים במילה נפרדת
        .replace(/(\s|^)([א-ת]+)\s*"\s*([א-ת]{1,2})(\s|$)/g, '$1$2__QUOTE__$3$4')     // הגן על אכרונים אמיתיים
        .replace(/(\s|^)([א-ת]+)\s*'\s*([א-ת]{1,2})(\s|$)/g, '$1$2__APOST__$3$4')     // הגן על אכרונים עם גרש

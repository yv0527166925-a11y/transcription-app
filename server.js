  ...
  try {
    ...
    sections.forEach(section => {
      ...
      combinedSection = combinedSection
        ...
        // אחר כך תקן פיסוק בין מילים נפרדות
        .replace(/([א-ת])\.(\s*)([א-ת])/g, '$1.&nbsp;$3')      // תקן נקודות בין מילים עבריות
        .replace(/([א-ת]),(\s*)([א-ת])/g, '$1,&nbsp;$3')     // תקן פסיקים בין מילים עבריות
        .replace(/([א-ת])"\s+([א-ת])/g, '$1"&nbsp;$2')     // תקן גרשיים בין מילים נפרדות (רק עם רווח)

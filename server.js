...
6. 🔒 **אל תחליף אף מילה** - תמלל בדיוק כמו שנאמר. אל תחליף, תשנה, תתקן או תשפר אף מילה. שמור על כל המילים המקוריות כולל ציטוטים, שגיאות, וריאציות ודרכי הגייה מיוחדות.
...
- 🔒 **אל תחליף אף מילה** - אל תחליף, תשנה, תתקן או תשפר אף מילה בתוכן. שמור על כל המילים כמו שהן כולל ציטוטים, שגיאות וריאציות. שפר רק את המירכאות ואת חלוקת הפסקאות.
...
7. 🔒 **אל תחליף אף מילה** - תמלל בדיוק כמו שנאמר. אל תחליף, תשנה, תתקן או תשפר אף מילה. שמור על כל המילים המקוריות כולל ציטוטים, שגיאות, וריאציות ודרכי הגייה מיוחדות.

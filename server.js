...
6. 🔒 **שמור על ציטוטים במדויק** - אל תשנה, תתקן או תשפר ציטוטים מקוריים (פסוקים, מאמרי חז"ל, אמרות). תמלל אותם בדיוק כמו שנאמרו, כולל שגיאות או וריאציות.
...
- 🔒 **שמור על ציטוטים במדויק** - אל תשנה, תתקן או תשפר את תוכן הציטוטים המקוריים (פסוקים, מאמרי חז"ל, אמרות). שמור על הניסוח המקורי כמו שהוא, כולל שגיאות או וריאציות. שפר רק את המירכאות סביבם.
...
7. 🔒 **שמור על ציטוטים במדויק** - אל תשנה, תתקן או תשפר ציטוטים מקוריים (פסוקים, מאמרי חז"ל, אמרות). תמלל אותם בדיוק כמו שנאמרו, כולל שגיאות או וריאציות.

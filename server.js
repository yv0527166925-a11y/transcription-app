...
תתחיל עכשיו עם התמלול:`;
    ...
    // Determine timeout based on retry count: 180s for first attempt, 240s for second attempt, 40s for third attempt
    const timeoutSeconds = retryCount === 0 ? 180 : (retryCount === 1 ? 240 : 40);

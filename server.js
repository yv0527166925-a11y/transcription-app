...
const maxGlobalConcurrency = 2; // Server protection: max 2 concurrent transcriptions globally (reduced for stability)
...
חריג לאיסור שינוי מילים – ניקוי חזרות בלבד:
למרות האיסור על שינוי מילים, מותר להסיר חזרות רצופות של אותה מילה או ביטוי כאשר מדובר בכפילות טכנית (כגון גמגום), כל עוד אין בכך שינוי של משמעות הדברים.

✔ דוגמאות:
"אני אני אומר" → "אני אומר"
"זה זה זה חשוב" → "זה חשוב"

❗ אם החזרה נראית כהדגשה או כחלק מהסגנון – יש להשאיר אותה כפי שנאמרה.
